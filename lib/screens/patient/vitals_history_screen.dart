        ...
        builder: (context, snap) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, i) {
              final v = list[i];
              final date =
                  '${v.timestamp.day.toString().padLeft(2, '0')}/${v.timestamp.month.toString().padLeft(2, '0')}';
              final time =
                  '${v.timestamp.hour.toString().padLeft(2, '0')}:${v.timestamp.minute.toString().padLeft(2, '0')}';
