...
class AiBotScreen extends StatefulWidget {
  ...
  @override
  State<AiBotScreen> createState() =>
      _AiBotScreenState();
}

class _AiBotScreenState
    extends State<AiBotScreen> {
  ...
  Map<String, dynamic>? _latestVitalsMap(
    AppState appState,
  ) {

    final VitalSample? lastVital =
        appState.getLatestVitals(
      widget.patient.id,
    );
