...
class _MoodScreenState extends State<MoodScreen> {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> _moodsStream() {
                      ...
                      Expanded(
                        child: _buildSectionCard(
                          ...
                          child: DropdownButtonFormField<String>(
                            initialValue:
                                _activities.contains(_selectedActivity)
                                ? _selectedActivity
                                : _activities[0],
                            isExpanded: true,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final moodColor =
                              _moods.firstWhere(
                                  ...
                                  as Color;
                          final activity = (data['activity'] ?? 'None')
                              .toString();
                          ...
                          return Container(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text(
                                'Sleep: ${data['sleepHours'] ?? '--'}h - Water: ${data['waterCups'] ?? '--'} cups',
