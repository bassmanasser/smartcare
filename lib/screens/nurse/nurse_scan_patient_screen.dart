...
class NurseScanPatientScreen extends StatefulWidget {
  final String nurseId;
  final String nurseName;

  const NurseScanPatientScreen({
    super.key,
  ...
  @override
  State<NurseScanPatientScreen> createState() => _NurseScanPatientScreenState();
}

class _NurseScanPatientScreenState extends State<NurseScanPatientScreen> {
  ...
  Future<void> _linkPatient(String rawId) async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          ...
          .doc('${widget.nurseId}_$linkedPatientDocId')
          .set({
        'linkedUserRole': 'nurse',
        'linkedUserId': widget.nurseId,
        'nurseId': widget.nurseId,
        'nurseName': widget.nurseName,
        'patientId': linkedPatientDocId,
        'patientName': patientName,
        'status': 'approved',
        'relationshipLabel': 'nurse_patient',
  ...
  Future<void> _scanQr() async {
    final result = await Navigator.of(context).push<String>(
      MaterialPageRoute(builder: (_) => const _NurseQrScannerPage()),
    );
...
class _NurseQrScannerPage extends StatefulWidget {
  const _NurseQrScannerPage();

  @override
  State<_NurseQrScannerPage> createState() => _NurseQrScannerPageState();
}

class _NurseQrScannerPageState extends State<_NurseQrScannerPage> {
  bool _handled = false;
